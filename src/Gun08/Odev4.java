...
* */
    ...
    public static void main(String[] args) {
        ...
        String parola = "KarsilaStirma";
        System.out.print("Parolanizi giriniz : ");
        String parolaTemp = oku.nextLine();
        int ayniMi = parola.compareToIgnoreCase(parolaTemp);

        // System.out.print(ayniMi);
        if (ayniMi== 0){
            System.out.println("Parolaniz dogru");
        }
        else {
